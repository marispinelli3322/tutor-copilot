...
export function QualityContent({ groupId, gameCode, period, maxPeriod, qualityData, periodLabel, periodLabelShort }: Props) {
  const { t } = useLocale();
        ...
        <div className="space-y-8">
          ...
          <Card className="overflow-hidden">
            <CardHeader className="bg-[#1A365D] py-3">
              <CardTitle className="text-base text-white">{t.qualityTitle} — {periodLabel} {period}</CardTitle>
            </CardHeader>
